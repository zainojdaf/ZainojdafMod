...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this._profileBtn = this.add.image(0, 0, "GJ_GameSheet03", "GJ_profileButton_001.png").setScrollFactor(0).setDepth(30).setScale(0.9).setInteractive().setOrigin(2, 0.9);
    ...
    this._profileNameText = this.add.bitmapText(0, 0, "goldFont", (window.AccountAPI && window.AccountAPI.currentUser) ? window.AccountAPI.currentUser.username : "Guest", 34)
      .setScrollFactor(0).setDepth(30).setOrigin(2, 0.9);
